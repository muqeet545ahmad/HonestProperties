...
const contactProviderController = require("../controllers/Contact_TypeProvider");
...
module.exports = (requireAuth, localAuth) => {
  ...
  router.post("/v1/contact/create", requireAuth,contactFormController.createContactForm);
  router.get("/v1/contact",requireAuth, contactFormController.readContact);
  router.post("/v1/contact/Update", requireAuth,contactFormController.updateContact);



  // ContactType endpoints
  // router.get(
  //   "/v1/contactTypes/listAll",
  //   requireAuth,contactFormController.readContactTypes
  // ); 

  /* contact Provider Routes */
  router.get("/v1/contactTypes/listAll", contactProviderController.listAll);
  router.post("/v1/contactTypes/add", requireAuth, contactProviderController.add);

  // router.post("/v1/bedroom/add", requireAuth, contactProviderController.add);

  //  // ContactType endpoints
  // router.get(
  //   "/v1/contactTypes/listAll",
  //   ContactTypeProviderController.listAll
  // );
  // router.post("/v1/contact/create", requireAuth,ContactTypeProviderController.add);
  ...
  router.get("/v1/user/profile", userController.readProfile);
  ...
  router.get(
    "/v1/user/profileImage",
    requireAuth,
    userController.readProfileImage
  );
  router.delete("/v1/user/hardDelete", userController.hardDelete);

  // property endpoints
  router.get("/v1/user/property", requireAuth, userController.readProperty);
  router.post(
    "/v1/user/property/update",
    requireAuth,
  ...
  router.post(
    "/v1/user/password/reset/verification",
    userVerificationController.sendVerificationEmail
  );
  router.post(
    "/v1/user/password/reset/update",
    userVerificationController.resetPassword
  );
  ...
  router.post(
    ...
    requireAuth,
    cpUpload,
    mediaController.saveImage
  );
  router.post(
    "/v1/media/addFloorPlan",
    requireAuth,
    mediaController.addFloorPlan
  );
  ...
  router.get(
    "/v1/room/listAllBedroomTypes",
    requireAuth,
    roomController.listAllTypes
  );
  ...
  router.post(
    "/v1/utilityprovider/add",
    requireAuth,
    utilityProviderController.add
  );
  ...
  router.get(
    "/v1/additionalFeature/listAll",
    additionalFeatureProviderController.listAll
  );
  router.post(
    "/v1/additionalFeature/add",
    requireAuth,
    additionalFeatureProviderController.add
  );
  ...
  router.get(
    "/v1/property",
    requireAuth,
    propertyInfoController.getPropertyDetails
  );

  // Property Info Routes
  router.post(
    "/v1/property/propertyinfo/create",
    requireAuth,
    propertyInfoController.createPropertyInfo
  );
  router.post(
    "/v1/property/propertyinfo/update",
    requireAuth,
    propertyInfoController.updatePropertyInfo
  );
  router.get(
    "/v1/property/propertyinfo/getbypropid",
    requireAuth,
    propertyInfoController.getPropertyInfoByPropertyId
  );

  // Property Profile routes
  router.post(
    "/v1/property/propertyprofile/create",
    requireAuth,
    propertyProfileController.createPropertyProfile
  );
  router.post(
    "/v1/property/propertyprofile/update",
    requireAuth,
    propertyProfileController.updatePropertyProfile
  );
